...
from .forms import RegistrationForm, LoginForm, PostForm, HistoryForm
...
def history():
    ...
    form.numqueries = numqueries
    form.content = posts

    return render_template('history.html', form=form, posts=posts, id=numqueries)
